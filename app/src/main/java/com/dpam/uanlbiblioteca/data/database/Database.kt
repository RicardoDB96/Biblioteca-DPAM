...
@Database(
    entities = [BookEntity::class, LibraryEntity::class, BookLibraryEntity::class, CategoryEntity::class, BookCategoryEntity::class, StudentEntity::class, MajorEntity::class, CampusEntity::class],
    version = 1,
    exportSchema = false
)
